export function supportedCodexRunner(args) {
  ...
  if (joined === 'features list') return { status: 0, stdout: 'multi_agent stable true\nmulti_agent_v2 stable false\nhooks stable true\n', stderr: '' };
...
export function hooksDisabledCodexRunner(args) {
  if (args.join(' ') === 'features list') {
    return { status: 0, stdout: 'multi_agent stable true\nmulti_agent_v2 stable false\nhooks stable false\n', stderr: '' };
  }
