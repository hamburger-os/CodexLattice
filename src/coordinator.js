...
export function transparentOrchestrationContext(plan, { permissionMode, activeModel } = {}) {
  ...
  const turnState = {
    nativeApprovalMode: permissionMode || null,
